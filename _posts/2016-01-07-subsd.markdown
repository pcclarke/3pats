...
function subsdChart() {
	...
	function ready (error, csim3840032, csim3840010) {
	  ...
	  var oldFedLine = svg.append("path")
		    .datum(csim3840032)
		    .attr("class", "line fedLine")
		    .attr("d", lineStart);

	  var newFedLine = svg.append("path")
		    .datum(csim3840010)
		    .attr("class", "line fedLine")
		    .attr("d", lineStart);

	  var oldProvLine = svg.append("path")
		    .datum(csim3840032)
		    .attr("class", "line provLine")
		    .attr("d", lineStart);

	  var newProvLine = svg.append("path")
		    .datum(csim3840010)
		    .attr("class", "line provLine")
		    .attr("d", lineStart);
